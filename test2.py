...
def load_data(filepath):
    try:
        ...
        # 3. Critical Failsafe
        required_cols = ['Physical limitations', 'is_not_suitable_for', 'Tags', 'Equipments', 'Exercise Name', 'Primary Category', 'Body Region', 'Age Suitability', 'MET value', 'Goal', 'Safety cue', 'Health benefit', 'Rest']
        for col in required_cols:
            if col not in df.columns:
                if col == 'MET value':
                    df[col] = 3.0
                elif col == 'Rest':
                    df[col] = 'None' # Changed default to None so we can detect missing vs exist
                else:
                    df[col] = 'None'
    ...
    for i, day in enumerate(days):
        ...
        if w1 is not None:
            day_plan['warmup'].append({
                ...
                "sets": "1",
                "reps": "2-3 mins", 
                "rest": get_dataset_rest(w1, "None"), # Applied logic
                "rpe": "3-4",
        ...
        if w2 is not None:
            day_plan['warmup'].append({
                ...
                "sets": "1",
                "reps": "10-15 reps", 
                "rest": get_dataset_rest(w2, "None"), # Applied logic
                "rpe": "2-3",
        ...
        if w3 is not None:
            day_plan['warmup'].append({
                ...
                "sets": "1",
                "reps": "10-15 reps", 
                "rest": get_dataset_rest(w3, "None"), # Applied logic
                "rpe": "2-3",
        ...
        if c1 is not None:
             day_plan['cooldown'].append({
                ...
                "sets": "1",
                "reps": "Hold 30-45 sec",
                "rest": get_dataset_rest(c1, "None"), # Applied logic
                "rpe": "1-2",
        ...
        if c2 is not None:
             day_plan['cooldown'].append({
                ...
                "sets": "1",
                "reps": "Hold 30-45 sec",
                "rest": get_dataset_rest(c2, "None"), # Applied logic
                "rpe": "1-2",
        ...
        if c3 is not None:
             day_plan['cooldown'].append({
                ...
                "sets": "1",
                "reps": "Hold 30-45 sec",
                "rest": get_dataset_rest(c3, "None"), # Applied logic
                "rpe": "1-2",
